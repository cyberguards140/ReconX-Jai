...
class ToolAdapter(PluginInterface):
    ...
    async def execute(self, config: dict, context: dict) -> dict:
                ...
                "findings": [
                    {
                        ...
                        "severity": "info",
                        "title": "No target",
                        "description": "No target specified for WHOIS",
                    }
                ],
                "metadata": {},
            }
                ...
                "findings": [
                    {
                        ...
                        "severity": "info",
                        "title": "Missing DB",
                        "description": "whois_servers.json not found",
                    }
                ],
                "metadata": {},
            }
                ...
                "findings": [
                    {
                        ...
                        "severity": "info",
                        "title": "Unsupported TLD",
                        "description": f"TLD {tld} not supported by local whois",
                    }
                ],
                "metadata": {},
            }
        ...
        if not whois_info:
            findings.append(
                {
                    "type": "whois_no_match",
                    "severity": "info",
                    "title": "No WHOIS match",
                    "description": f"No WHOIS data for {target}",
                }
            )
            ...
            findings.append(
                {
                    "type": "whois_error",
                    "severity": "info",
                    "title": "WHOIS connection error",
                    "description": whois_info["error"],
                }
            )
        else:
            ...
            if registrar:
                assets.append(
                    {"type": "registrar", "value": registrar, "tags": ["whois", "infrastructure"]}
                )
