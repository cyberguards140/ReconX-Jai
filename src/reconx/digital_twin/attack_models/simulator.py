...
class AttackSimulator:
    ...
    def simulate_campaign(self, twin_snapshot: Dict[str, Any], actor_profile: str = "ransomware") -> Dict[str, Any]:
        """
        Runs a theoretical attack against the twin snapshot.
        """
        logger.info(f"Simulating {actor_profile} campaign against twin version {twin_snapshot.get('version')}")
