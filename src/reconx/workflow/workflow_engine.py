...
from reconx.workflow.models.workflow import Workflow, WorkflowTask, WorkflowExecution, TaskExecutionState
...
from reconx.workflow.exceptions import WorkflowValidationError, WorkflowExecutionError
...
class WorkflowEngine:
    ...
    async def execute_workflow(
        ...
        async with async_session_factory() as db:
            ...
            event_type = "WorkflowCompleted" if execution.status == WorkflowState.COMPLETED else "WorkflowFailed"
            await event_bus.publish(WorkflowEvent(
                event_id=execution_id,
