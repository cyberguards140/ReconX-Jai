...
DB_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', '..', '..', 'workspace', 'cases.db'))
...
class Case(Base):
    ...
    status = Column(String, default="Open") # Open, Assigned, In Progress, Pending Review, Resolved, Closed
