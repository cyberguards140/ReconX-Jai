...
async def update_tenant_status(tenant_id: str, req: TenantStatusUpdate, current_user: Any = Depends(require_admin)):
...
async def create_organization(tenant_id: str, req: OrganizationCreateRequest, current_user: Any = Depends(require_admin)):
