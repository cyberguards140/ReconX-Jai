from integrations.adapters import SubfinderAdapter, DnsxAdapter, HttpxAdapter, NaabuAdapter, NmapAdapter
...
PIPELINES = {
    ...
    "Full Cloud Enumeration": ["cloud_discovery", "storage_discovery", "iam_discovery", "relationships", "risk_analysis"]
}
