...
class IOCEngine:
    ...
    def __init__(self):
        ...
        self._ioc_db = {"192.168.1.100": {"ioc_id": "ioc_001", "threat_level": "high"}}
    ...
    def match_asset(self, asset: UnifiedAsset) -> dict[str, Any]:
        ...
        if asset.value in self._ioc_db:
            ...
            matched_iocs.append({"ioc_id": ioc_data["ioc_id"], "value": asset.value})
            threat_score += 80 if ioc_data["threat_level"] == "high" else 40

        return {"asset": asset.asset_id, "matched_iocs": matched_iocs, "threat_score": threat_score}
