...
class CorrelationEngine:
    ...
    def process_result(task: Dict[str, Any]):
        ...
        with SessionLocal() as db:
            ...
            if risk_score >= 70:
                logger.critical(f"HIGH PRIORITY RISK ALERT: Asset {target} has reached critical mass ({risk_score}/100) due to complex correlation chains!")
                ...
                asyncio.create_task(alert_notifier.dispatch_alert({
