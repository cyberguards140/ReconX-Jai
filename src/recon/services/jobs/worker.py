...
from recon.services.jobs.queue import job_queue
from recon.services.observability.metrics import metrics
...
class JobWorker:
    ...
    async def process_job(self, job: dict):
        ...
        # Simulate execution
        from core.legacy_core.capabilities import capability_manager
