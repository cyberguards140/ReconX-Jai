...
from platform_core.workflow_engine.workflow.exceptions import WorkflowValidationError
from platform_core.workflow_engine.workflow.execution_context import ExecutionContext
from platform_core.workflow_engine.workflow.local_scheduler import WorkflowScheduler
from platform_core.workflow_engine.workflow.models.workflow import (
    TaskExecutionState,
    Workflow,
    WorkflowExecution,
    WorkflowTask,
...
from platform_core.workflow_engine.workflow.validator import WorkflowValidator
...
class WorkflowEngine:
    ...
    async def execute_workflow(
        ...
        async with async_session_factory() as db:
            ...
            from core.legacy_core.pipeline import IngestionPipeline
