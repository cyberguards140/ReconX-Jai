...
async def execute_workflow(workflow_name: str, payload: Dict[str, Any], current_user: Any = Depends(get_current_user)):
    ...
    try:
        ...
        return {"status": "success", "execution_id": execution_id, "message": "Workflow execution queued."}
...
async def trigger_ad_hoc_job(job_type: str, payload: Dict[str, Any], current_user: Any = Depends(get_current_user)):
