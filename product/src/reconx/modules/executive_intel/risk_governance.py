import uuid
from reconx.modules.executive_intel.schema import RiskModel
...
class RiskGovernanceEngine:
    ...
    def calculate_enterprise_risk(self, technical_score: int, criticality: str, compliance_impact: bool) -> int:
