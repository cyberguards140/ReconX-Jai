...
class TopologyBuilder:
    ...
    def build_zones(self, assets: List[UnifiedAsset]) -> List[TopologyZone]:
        ...
        internet_zone = TopologyZone(zone_name="Internet Zone", description="Publicly reachable assets")
        internal_zone = TopologyZone(zone_name="Internal Exposure Layer", description="Internal assets")
