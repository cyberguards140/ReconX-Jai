...
from reconx.modules.network.targets import TargetExpander
...
class NetworkOrchestrator:
    ...
    @staticmethod
    async def run_network_recon(target_str: str, profile: ScanProfile, user_id: str = "system") -> Dict[str, Any]:
        """
