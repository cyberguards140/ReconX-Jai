import os
from sqlalchemy import create_engine, Column, String, Integer, DateTime, ForeignKey, Text, Float, Boolean
from sqlalchemy.orm import declarative_base, sessionmaker
from datetime import datetime
import uuid

DB_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', '..', '..', 'workspace', 'campaigns.db'))
...
class Campaign(Base):
    ...
    status = Column(String, default="Draft") # Draft, Planning, Active, Reporting, Completed, Archived
