...
from reconx.utils.http_client import HttpClient, is_private_ip, resolve_and_check_ssrf
...
@patch("reconx.utils.http_client.socket.getaddrinfo")
...
@patch("reconx.utils.http_client.requests.Session")
def test_http_client_get(mock_session_cls):
    ...
    with patch("reconx.utils.http_client.resolve_and_check_ssrf"):
