...
from reconx.services.auth.auth_service import register_user, authenticate_user
from reconx.services.auth.jwt_manager import (
    create_access_token,
    verify_token,
...
@pytest.mark.asyncio
@patch("reconx.services.auth.auth_service.user_repo")
@patch("reconx.services.auth.auth_service.password_history_repo")
@patch("reconx.services.auth.auth_service.log_audit_event")
...
@pytest.mark.asyncio
@patch("reconx.services.auth.auth_service.verify_password")
